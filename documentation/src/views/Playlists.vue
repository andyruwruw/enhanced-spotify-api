<template>
    <div class="Playlists">
        ...
        <div class="page-content">
            <h1 class="display-1">Playlists Container</h1>
            <p>The <span class="highlight">Playlists</span> container class is used to retrieve and maintain data from Spotify's API on a list of playlists.</p>
            ...
            <DataObject :properties="properties">
                ...
                <div slot="methods-content">
                    ...
                    <ContainerMethods container="Playlists" contents="Playlist"/>
