<template>
    <div class="Categories">
        ...
        <div class="page-content">
            <h1 class="display-1">Categories Container</h1>
            <p>The <span class="highlight">Categories</span> container class is used to retrieve and maintain data from Spotify's API on a list of categories.</p>
            ...
            <DataObject :properties="properties">
                ...
                <div slot="methods-content">
                    ...
                    <ContainerMethods container="Categories" contents="Category"/>
