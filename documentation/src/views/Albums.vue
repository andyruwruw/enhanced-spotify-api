<template>
    <div class="Albums">
        ...
        <div class="page-content">
            <h1 class="display-1">Albums Container</h1>
            <p>The <span class="highlight">Albums</span> container class is used to retrieve and maintain data from Spotify's API on a list of albums.</p>
            ...
            <DataObject :properties="properties">
                ...
                <div slot="methods-content">
                    ...
                    <ContainerMethods container="Albums" contents="Album"/>
